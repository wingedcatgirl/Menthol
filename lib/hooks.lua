...
function get_next_tag_key(...)
    if G.GAME and false --[[deck is suit focus]] and not G.GAME.minty_suit_focus_first_tag_generated then
...
--Hook tba: force the pack generated by that first charm tag to include Lovers and Tower
