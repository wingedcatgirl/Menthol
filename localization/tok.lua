...
--          ["k_minty_treat_packs"] = "Treat Pack",
            ["k_minty_everycard_packs"] = "poki pi ale lipu",
...
--]]
        ...
        ["v_text"] = {
--[[
       		["ch_c_all_minty_counterfeit"] = "All cards are {C:attention}Counterfeit{}",
       		["ch_c_minty_ante_dollarpenalty"] = "Starting Ante {C:attention}#1#{}, {C:mult}-1{} Mult per {C:gold}$1{} held",
--]]
        },
        ["suits_plural"] = {
            ["minty_3s"] = "3",
...
--          ["k_minty_special"] = "Special",
        ...
        ["challenge_names"] = {
            ["c_minty_raidnight"] = "utala tenpo wan",
            ["c_minty_raidnightsavage"] = "utala tenpo wan (suli utala)",
            ["c_minty_backalley"] = "nasin len",
            ["c_minty_evilbackalley"] = "nasin len monsuta",
